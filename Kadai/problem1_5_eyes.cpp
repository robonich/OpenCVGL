...
{
  // 1. load classifier
  std::string cascadeName = "Nariz.xml";//"haarcascade eye.xml";//"frontalEyes35x16.xml";//"/usr/local/share/OpenCV/haarcascades/haarcascade_frontalface_alt.xml"; //Haar-like
