...
void find_center(GLdouble *a, GLdouble *b, GLdouble *c);
...
void draw_pyramid(){
	...
	glBindTexture(GL_TEXTURE_2D, g_TextureHandles[1]);//set different texture
	...
	glBindTexture(GL_TEXTURE_2D, g_TextureHandles[0]);//reset texture
	glEnable(GL_TEXTURE_2D);
